            ...
            <div class="row">
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-12">
                      <span class="current-stock">Pantalones disponibles</span>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
					...
					<div class="col-sm-12">
                      <span class="item-price">Q. <?php echo number_format($row['precio_producto'],2);?></span>
                    </div>
                    <br> <br> <br> <br> <br> 
                    ...
                    <div class="col-sm-6 col-xs-6 col-md-4 ">
                      <a href="" data-toggle="modal" data-target="#add-stock"><img width="80px"  src="img/ingreso.png"></a>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-4">
                      <a href="" data-toggle="modal" data-target="#remove-stock"><img width="75px"  src="img/egreso.png"></a>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
