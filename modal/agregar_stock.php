  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="reference" class="col-sm-2 control-label">Costo Total</label>
            <div class="col-sm-6">
              <input type="text" name="reference" class="form-control" id="reference" value="" placeholder="Costo Total Ingreso">
            </div>
          </div>
