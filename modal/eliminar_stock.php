  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Eliminar Existencia</h4>
      </div>
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="reference" class="col-sm-2 control-label">Costo Compra</label>
            <div class="col-sm-6">
              <input type="text" name="reference_remove" class="form-control" id="reference_remove" value="" placeholder="Consto Compra">
            </div>
          </div>
