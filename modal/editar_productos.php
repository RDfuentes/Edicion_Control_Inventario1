		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  <div class="form-group">
				<label for="mod_codigo" class="col-sm-3 control-label">Código Color Tela</label>
				<div class="col-sm-8">
			   ...
			   <div class="form-group">
				<label for="mod_nombre" class="col-sm-3 control-label">Nombre Talla</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="mod_categoria" class="col-sm-3 control-label">Talla Pantalon</label>
				<div class="col-sm-8">
